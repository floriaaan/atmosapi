...
def updateMeasures(measureDate, measureTemp, measureHumidite, measureTable):
...
# Todo
# shows a single measure item and lets you delete a measure
...
# TodoList
# shows a list of all measures, and lets you POST to add new measures
